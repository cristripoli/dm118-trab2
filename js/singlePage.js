var SinglePage = {
    ...
    getInnerHeigh : function () {
        ...
        document.getElementById('home').style.height = document.getElementById('home').style.height/h + "%";
        document.getElementById('portfolio').style.height = document.getElementById('portfolio').style.height/h + "%";
        document.getElementById('sobre').style.height = document.getElementById('sobre').style.height/h + "%";
